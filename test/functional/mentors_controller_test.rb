...
class MentorsControllerTest < ActionController::TestCase
  ...
  test "should create mentor" do
    assert_difference('Mentor.count') do
      post :create, mentor: { FirstName: @mentor.FirstName, LastName: @mentor.LastName, department: @mentor.department, email: @mentor.email, phone: @mentor.phone, title: @mentor.title }
    end
  ...
  test "should update mentor" do
    put :update, id: @mentor, mentor: { FirstName: @mentor.FirstName, LastName: @mentor.LastName, department: @mentor.department, email: @mentor.email, phone: @mentor.phone, title: @mentor.title }
    assert_redirected_to mentor_path(assigns(:mentor))
  end
