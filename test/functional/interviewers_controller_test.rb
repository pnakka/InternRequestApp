...
class InterviewersControllerTest < ActionController::TestCase
  ...
  test "should create interviewer" do
    assert_difference('Interviewer.count') do
      post :create, interviewer: { Email: @interviewer.Email, FirstName: @interviewer.FirstName, LastName: @interviewer.LastName, phone: @interviewer.phone, title: @interviewer.title }
    end
  ...
  test "should update interviewer" do
    put :update, id: @interviewer, interviewer: { Email: @interviewer.Email, FirstName: @interviewer.FirstName, LastName: @interviewer.LastName, phone: @interviewer.phone, title: @interviewer.title }
    assert_redirected_to interviewer_path(assigns(:interviewer))
  end
